...
class Users implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: FavoriteCities::class, orphanRemoval: true)]
    ...
    /**
     * @return Collection<int, FavoriteCities>
     */
    ...
    public function addFavoriteCity(FavoriteCities $favoriteCity): static
    {
        if (!$this->favoriteCities->contains($favoriteCity)) {
            $this->favoriteCities->add($favoriteCity);
    ...
    public function removeFavoriteCity(FavoriteCities $favoriteCity): static
    {
